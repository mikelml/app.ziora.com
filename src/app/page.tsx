    ...
    <div className="min-h-screen bg-[#F5F2EA] text-[#2D3A33]">
      ...
      <header
        className={`fixed top-0 w-full z-50 transition-all duration-300 ${
          isScrolled
            ? "bg-[#F5F2EA]/95 backdrop-blur-sm shadow-sm"
            : "bg-transparent"
        }`}
      >
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <Image
            ...
            priority
          />
          <div className="text-2xl font-bold font-['Poppins'] text-[#507060]">
            Ziora
          </div>
          ...
          <nav className="hidden md:flex space-x-8">
            <button
              ...
              className="hover:text-[#507060] transition-colors"
            >
              Features
            </button>
            <button
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-[#F5F2EA] border-t border-[#CFEADE] px-4 py-4">
            <nav className="flex flex-col space-y-4">
              <button
                onClick={() => scrollToSection("features")}
                className="text-left hover:text-[#507060] transition-colors"
              >
                Features
              </button>
              <button
      ...
      <div className="pt-24 pb-16 px-4 hero-section">
        ...
        <div className="container mx-auto text-center max-w-4xl hero-section">
          ...
          <p className="text-xl md:text-2xl mb-8 text-[#608070] max-w-2xl mx-auto leading-relaxed">
            AI-powered clinical documentation that lets therapists focus on what
        ...
        <div className="container mx-auto px-4 hero-section">
          <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <div className="space-y-8">
              <h2 className="text-3xl font-bold font-['Poppins'] text-[#507060] mb-8">
                The Current Crisis
              </h2>
              ...
              <div className="space-y-6">
                <div className="bg-white/95 p-6 rounded-xl shadow-sm">
                  ...
                  <ul className="space-y-2 text-[#608070]">
                    ...
                    <li>
                      • $1T annual economic loss from untreated mental health
                    </li>
                  </ul>
                </div>
            ...
            <div className="space-y-8 bg-white/95 rounded-xl p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <CheckCircle
                    className="text-[#507060] flex-shrink-0"
                    size={24}
                  />
                ...
                <div className="flex items-center space-x-3">
                  ...
                  />
                  <span>
                    Increase session focus with real-time transcription
                  </span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="bg-white/70 border-[#CFEADE] rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 hover:scale-105">
              <CardHeader>
                ...
                <CardDescription>
                  Real-time speech-to-text for telehealth and in-person sessions
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-white/70 border-[#CFEADE] rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 hover:scale-105">
              <CardHeader>
                ...
                <CardDescription>
                  Automated SOAP/DAP note drafts from session transcripts
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-white/70 border-[#CFEADE] rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 hover:scale-105">
              <CardHeader>
                ...
                <CardDescription>
                  AI-powered risk assessment and clinical story analysis
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-white/70 border-[#CFEADE] rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 hover:scale-105">
              <CardHeader>
                ...
                <CardDescription>
                  Smart analytics with HIPAA-secure EHR synchronization
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-white/70 border-[#CFEADE] rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 hover:scale-105">
              <CardHeader>
                ...
                <CardDescription>
                  Daily follow-ups and engagement tracking for patients
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-white/70 border-[#CFEADE] rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 hover:scale-105">
              <CardHeader>
                ...
                <CardDescription>
                  Multi-layer data protection with enterprise-grade security
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
      ...
      <section
        id="how-it-works"
        className="py-16 bg-gradient-to-br from-[#CFEADE]/20 to-[#F5F2EA]"
      >
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-8 md:space-y-0 md:space-x-8">
            <div className="flex flex-col items-center text-center max-w-xs">
              <div className="bg-[#507060] text-white rounded-full w-16 h-16 flex items-center justify-center mb-4 text-xl font-bold">
                1
              </div>
              <h3 className="font-semibold mb-2">Capture</h3>
              <p className="text-sm text-[#608070]">
                Record therapy sessions with consent
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center max-w-xs">
              ...
              <p className="text-sm text-[#608070]">
                Real-time transcription with clinical accuracy
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center max-w-xs">
              ...
              <p className="text-sm text-[#608070]">
                LLM processing with sentiment analysis
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center max-w-xs">
              ...
              <p className="text-sm text-[#608070]">
                JSON format for EHR integration
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center max-w-xs">
              ...
              <p className="text-sm text-[#608070]">
                Clinical notes and insights delivered
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="pricing" className="py-16 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <Card className="bg-white/70 border-[#CFEADE] rounded-xl shadow-lg p-8 max-w-md mx-auto">
            <CardHeader>
              <CardTitle className="text-2xl font-['Poppins'] text-[#507060]">
                Professional Plan
              </CardTitle>
            ...
            <CardContent>
              <div className="text-4xl font-bold text-[#507060] mb-4">
                $59
                <span className="text-lg font-normal text-[#608070]">
                  /clinician/month
                </span>
              </div>
              ...
              <div className="text-center">
                <p className="text-sm text-[#608070] mb-4">
                  Enterprise EHR licenses available
                </p>
                <Button
      ...
      <section className="py-16 bg-gradient-to-br from-[#F5F2EA] to-[#CFEADE]/20">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              <Badge className="bg-[#CFEADE] text-[#2D3A33] mb-4">
                Q2 2026
              </Badge>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <Card className="bg-white/70 border-[#CFEADE] rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 text-center">
              ...
              <CardContent>
                <p className="text-sm text-[#608070]">
                  Expert in machine learning and healthcare data systems with 8+
                  years experience.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/70 border-[#CFEADE] rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 text-center">
              ...
              <CardContent>
                <p className="text-sm text-[#608070]">
                  Full-stack developer specializing in scalable healthcare
            ...
            <Card className="bg-white/70 border-[#CFEADE] rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 text-center">
              <CardHeader>
                ...
                <CardDescription>
                  Seeking Licensed Clinical Psychologist
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-[#608070]">
                  Join our team to guide clinical best practices and product
                  development.
                </p>
              </CardContent>
            </Card>
      ...
      <footer id="beta-signup" className="py-16 bg-[#507060] text-white">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-xl mb-8 text-[#CFEADE] leading-relaxed">
            Be among the first to experience the future of clinical
            documentation.
          </p>
          ...
          <div className="border-t border-[#608070] pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <div className="flex space-x-6 text-sm">
                <a href="#" className="hover:text-[#CFEADE] transition-colors">
                  Privacy Policy
                </a>
                <a href="#" className="hover:text-[#CFEADE] transition-colors">
                  Terms of Service
